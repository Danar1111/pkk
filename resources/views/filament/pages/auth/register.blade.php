<div class="login-wrapper">
    <style>
        *, *::before, *::after {
        ...
        .login-right-inner {
            width: 100%;
            max-width: 440px; /* Slightly wider for register inputs grid */
        }
    ...
    <div class="login-left">
        ...
        <div class="login-left-content">
            ...
            <!-- Desc -->
            <p class="left-desc">
                Isi formulir pendaftaran untuk membuat akun baru. Akun Anda akan ditinjau dan diaktifkan oleh Administrator sistem.
            </p>
    ...
    <div class="login-right">
        <div class="login-right-inner">
            ...
            <!-- Filament Register Form -->
            {{ $this->content }}

            <!-- Login Footer Link -->
            <div class="auth-footer">
                Sudah punya akun? <a href="{{ filament()->getLoginUrl() }}">Masuk</a>
            </div>
        </div>
    </div>
</div>
