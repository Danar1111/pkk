            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div data-aos="fade-up" class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center text-xs font-bold">KB</div><span class="font-semibold text-tertiary">Hj. Nining Kurnia</span> <span class="text-sm text-neutral">(Ketua Bidang)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">KP</div><span class="font-medium text-tertiary">Elis Herlina, A.Md.</span> <span class="text-sm text-neutral">(Ketua Pokja)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">WK</div><span class="font-medium text-tertiary">Hj. Karmilah, S.Ag., M.Sc.</span> <span class="text-sm text-neutral">(Wakil Ketua)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">S</div><span class="font-medium text-tertiary">Hj. Aidah Masruroh, S.Sos.</span> <span class="text-sm text-neutral">(Sekretaris)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Hani Nurazizah Hanifah, S.P.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Hj. Erni Herniani</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Irma Wahyuni, S.M.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div data-aos="fade-up" class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        <h4 class="font-bold text-sm text-tertiary uppercase tracking-wider mb-4">Susunan Anggota</h4>
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-secondary text-tertiary flex items-center justify-center text-xs font-bold">KB</div><span class="font-semibold text-tertiary">Hj. Mutia Kuswidiaty, S.Sos.</span> <span class="text-sm text-neutral">(Ketua Bidang)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">KP</div><span class="font-medium text-tertiary">Hj. Sri Hartini, S.Pd.</span> <span class="text-sm text-neutral">(Ketua Pokja)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">WK</div><span class="font-medium text-tertiary">Tantan Sri Mulyani, S.Sos., M.Si.</span> <span class="text-sm text-neutral">(Wakil Ketua)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">S</div><span class="font-medium text-tertiary">Dida Jubaedah, A.KS.</span> <span class="text-sm text-neutral">(Sekretaris)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Hj. Widanengsih, S.Pd.I.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Yani Mulyani, S.Pd.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Astri Yulianti Hasanah</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div data-aos="fade-up" class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        <h4 class="font-bold text-sm text-tertiary uppercase tracking-wider mb-4">Susunan Anggota</h4>
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-green-600 text-white flex items-center justify-center text-xs font-bold">KB</div><span class="font-semibold text-tertiary">Hj. Renny Oktavianny R., S.Pd.</span> <span class="text-sm text-neutral">(Ketua Bidang)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">KP</div><span class="font-medium text-tertiary">Iis Siti Mulyati</span> <span class="text-sm text-neutral">(Ketua Pokja)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">WK</div><span class="font-medium text-tertiary">Yulia Purwati Permanik</span> <span class="text-sm text-neutral">(Wakil Ketua)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">S</div><span class="font-medium text-tertiary">Ani Purwanti</span> <span class="text-sm text-neutral">(Sekretaris)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Dede Herna Murnina</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Isykarima Aumut</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Eka Dewi, M.Si.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Hj. Aan Sutiani, S.TR.Keb</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div data-aos="fade-up" class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        <h4 class="font-bold text-sm text-tertiary uppercase tracking-wider mb-4">Susunan Anggota</h4>
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center text-xs font-bold">KB</div><span class="font-semibold text-tertiary">Ekki Riswandyah, S.KM., M.KM.</span> <span class="text-sm text-neutral">(Ketua Bidang)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">KP</div><span class="font-medium text-tertiary">drg. Hj. Hanah Zaitunah Fuadi, M.KM.</span> <span class="text-sm text-neutral">(Ketua Pokja)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">WK</div><span class="font-medium text-tertiary">Hj. Irma Devianty</span> <span class="text-sm text-neutral">(Wakil Ketua)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">S</div><span class="font-medium text-tertiary">Andry Sutisna Sudradjat, S.Pd.</span> <span class="text-sm text-neutral">(Sekretaris)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Dian Rahmawati, S. Kep.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Evy Rosvianty, S.Km., M.KM.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                            <li class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-white border border-gray-200 text-tertiary flex items-center justify-center text-xs font-bold">A</div><span class="font-medium text-tertiary">Ai Siti Nurjanah, S.KM.</span> <span class="text-sm text-neutral">(Anggota)</span></li>
                        </ul>
                    </div>
                </div>
            </div>
